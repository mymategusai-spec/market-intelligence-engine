...
| `MUNI-HAKUBA-TOURISM` | `vill.hakuba.lg.jp/material/files/group/7/` | 白馬村 Hakuba Village | 2026 | 2026-08-20 | **19-year foreign overnight-stay series by nationality and month (2006–2024)**, ski-resort user numbers by resort and month, visitor arrivals. Richer than anything in the national dataset. Flags 2019–20 as mobile-phone estimates. | **2** |
| `JP-JTA-SHUKUHAKU` | `mlit.go.jp/kankocho/content/001905698.pdf` | 観光庁 Japan Tourism Agency | 2025 | 2026-08-20 | 2024 **final** occupancy by prefecture and facility type; prefecture overnight-stay totals. Nagano 39.6% (rank 47), Niigata 45.5%, Hokkaido 59.8%. | **1** |
| `MLIT-HOKUSHIN-MYOKO` | `wwwtb.mlit.go.jp/hokushin/content/000117742.pdf` | MLIT 北陸信越運輸局 | — | 2026-08-20 | Myoko foreign overnight stays 2017–18, ~80% Jan–Mar, Australians ~70% of inbound, FIT, staying weeks to two months. | **1** |
| `PREF-NAGANO` | `tokei.pref.nagano.lg.jp` | Nagano Prefecture | 2025-08-22 | 2026-08-20 | 2024 tourism statistics: 40.0m visitors (+13.2%), spend ¥1,004,716m (+17.5%), quarterly breakdown showing summer as the largest quarter. | **2** |
| `PORTAL-HOMES` | `homes.co.jp` | LIFULL HOME'S | — | 2026-08-20 | 152 Yuzawa apartment listings and 8 Myoko houses via schema.org JSON-LD on public listing pages. **robots.txt checked** — listing pages not disallowed. Collection stopped at HTTP 202 rate limiting. | 4 |
| `AGENCY-SKIASIA` | `skiasia.com` | Ski Asia | 2023–2026 | 2026-08-20 | Editorial listing round-ups. Source of most candidate properties and of two of the three observed price reductions. **Conflict: carries agency listings.** | 5 |
| `AGENCY-UCHI` | `uchijapan.com` | Uchi Japan Real Estate | 2026-07-15 | 2026-08-20 | Myoko listings with sizes and licence status. **Conflict: agency with transactional interest.** | 4 |
| `SEC-RENOVATION-JP` | various | Japanese renovation and fire-safety contractors, administrative scriveners | 2025–2026 | 2026-08-20 | Construction deflator 130.9; snow-country 1.5–2.0× roof/exterior premium; 簡易宿所 fire compliance ~¥300k detached, to ¥10m where sprinklers trigger; ¥1–3m minimum to open. | 4 |
...
| `JP-JTA-2025` | JTA 2025 annual accommodation release PDF | **HTTP 404** on direct fetch (2026-08-20) | 2024 final release retrieved instead (Tier 1). The 2025 headline figures (total −0.8%, Japanese −3.8%, foreign +8.2%) are recorded from the search index of that PDF and flagged as not directly retrieved. |
| `PORTAL-HOMES` (Hakuba, Nozawa, Kutchan, Iiyama) | LIFULL HOME'S municipal listing pages | **HTTP 202 rate limiting** after several requests (2026-08-20) | Collection stopped rather than pressed. Hakuba and Nozawa also returned no used-house listings at all, which is itself recorded as a scarcity signal. |
| `PREF-NIIGATA` opendata page | Niigata tourism open data | **HTTP 404** (2026-08-20) | Myoko data obtained from MLIT Hokushinetsu and the city's own tourism plan instead. |
